    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[(UWEFlixApp.models.user.User.Role['CINEMA_MANAGER'], 'M'), (UWEFlixApp.models.user.User.Role['ACCOUNT_MANAGER'], 'A'), (UWEFlixApp.models.user.User.Role['CLUB_REP'], 'R'), (UWEFlixApp.models.user.User.Role['CUSTOMER'], 'C')], max_length=1)),
